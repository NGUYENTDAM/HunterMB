...
if(isset($_SESSION["GioHang"]))
{
    ...
    for($i = 0; $i < $soLuongSanPham; $i++)
    {
        ...
        // thêm bảng chi tiết đơn đặt hàng
        $sql = "INSERT INTO ct_dondathang(MaChiTietDonDatHang, SoLuong, GiaBan, MaDonDatHang, MaSanPham)
